...
import ModalMed from "../../components/Modal";
import Login from "../auth/login";
import React, { useEffect } from "react";

export default function FirstPost() {
  function loginToggle(overlay:any) {
  ...
  return (
    <>
      ...
      <div className="grid min-h-screen p-4 bg-gray-900 place-items-center ">
        <div className="relative w-2/3 h-[360px] bg-white overflow-hidden rounded-full">
          {/* Top-left circle */}
          <div
            aria-hidden="true"
            className="-top-15 -left-10 absolute w-[200px] h-[200px] bg-purple-300 rounded-full"
          >
            <PlayIcon className="w-[200px] h-[200px] text-purple-400" />
          </div>
          {/* Right big circle */}
          <div
            aria-hidden="true"
            className="rounded-full w-[512px] h-[512px] bg-purple-400 absolute -top-20 -right-56"
          ></div>
          {/* Images */}
          <div className="absolute top-8 right-8">
            <img
              src="/Capture1.jpg"
              alt=""
              className="object-cover w-64 rounded-lg shadow-2xl h-36 rotate-3"
            />
            <img
              src="/Capture2.jpg"
              alt=""
              className="object-cover w-64 translate-x-16 rounded-lg shadow-2xl h-36 -rotate-3"
            />
          </div>
          {/* play button */}
          <div className="absolute inset-y-0 grid items-center justify-center transition right-12">
            <Link replace href="/">
              <a
                className="block w-12 h-12 bg-indigo-300 rounded-full ring-1 place-items-center animate-pulse ring-emerald-200 hover:ring-cyan-300 hover:bg-cyan-400"
              >
                <span className="sr-only">نمونه کار پزشکی</span>
                <PlayIcon className="animate-pulse " />
              </a>
            </Link>
          </div>
          {/* content */}
          <div className="relative flex flex-col items-end justify-end w-2/3 h-full p-8 space-y-4">
            <p className="font-semibold tracking-wider text-purple-600 first-letter:text-red-600 first-letter:text-2xl ">
              چگونه می توانید وارد متاورس شوید
            </p>
            <h1 className="text-4xl font-extrabold tracking-wider text-right">
              آرپوت با خدمات خود اینکار را برای شما انجام میدهد
            </h1>
            {/* Logo */}
            <svg
              id="logo"
              className="items-center justify-center h-12 w-28"
              viewBox="0 0 420 30"
              fill="none"
          ...
          <div className="w-1/3 overflow-x-hidden bg-yellow-700">
            fffffffffffffff
          </div>
        </div>

        {/* <Link href="/"> */}
        {/* <div onClick={() => Router.back()} className="btn btn-info">
          Back NOW!!!!
        </div>
        <div id="runBtn" className="btn btn-info">
          Modal
        </div> */}
        {/* </Link> */}
      </div>
